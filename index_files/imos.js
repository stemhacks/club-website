...
IMOS.ready = false;
IMOS.visitorId = "";
IMOS.server = "https://imos001-dot-im--os.appspot.com";//"https://im--os.appspot.com";
IMOS.siteId = "";
...
//		        myscript.src = IMOS.server + '/js/imos.js?v=2';
//		        iFrameHead.appendChild(myscript);
//		        console.log("loaded imos script to inner frame");
//			}
		};
