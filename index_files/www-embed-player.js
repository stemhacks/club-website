...
function ak(a){var b="mouseover"==a.type&&"mouseenter"in Xj||"mouseout"==a.type&&"mouseleave"in Xj,c=a.type in Xj||b;if("HTML"!=a.target.tagName&&c){if(b){var b="mouseover"==a.type?"mouseenter":"mouseleave",c=Xj[b],d;for(d in c.ha){var e=Zj(b,d,a.target);e&&!Oe(a.relatedTarget,function(a){return a==e},!0)&&c.B(d,e,b,a)}}if(b=Xj[a.type])for(d in b.ha)(e=Zj(a.type,d,a.target))&&b.B(d,e,a.type,a)}}
...
"paddingRight");n=jg(c,"paddingTop");var A=jg(c,"paddingBottom"),m=new ag(n,k,A,m)}else m=cg(c,"paddingLeft"),k=cg(c,"paddingRight"),n=cg(c,"paddingTop"),A=cg(c,"paddingBottom"),m=new ag(parseFloat(n),parseFloat(k),parseFloat(A),parseFloat(m));if(K&&!qd(9)){k=lg(c,"borderLeft");n=lg(c,"borderRight");var A=lg(c,"borderTop"),jb=lg(c,"borderBottom"),k=new ag(A,n,jb,k)}else k=cg(c,"borderLeftWidth"),n=cg(c,"borderRightWidth"),A=cg(c,"borderTopWidth"),jb=cg(c,"borderBottomWidth"),k=new ag(parseFloat(A),
parseFloat(n),parseFloat(jb),parseFloat(k));f.pixelWidth=h.width-k.left-m.left-m.right-k.right;f.pixelHeight=h.height-k.top-m.top-m.bottom-k.bottom}else f.pixelWidth=h.width,f.pixelHeight=h.height;h=window.document;h=De(h)?h.documentElement:h.body;f=new je(h.clientWidth,h.clientHeight);1==c.nodeType?(c=eg(c),k=new se(c.left,c.top)):(c=c.changedTouches?c.changedTouches[0]:c,k=new se(c.clientX,c.clientY));c=gg(d);n=Math.floor(c.width/2);h=!!(f.height<k.K+a.height);a=!!(k.K<a.height);m=!!(k.J<n);f=!!(f.width<
...
function hl(a,b,c){function d(a,b){if(jb)return 0;uk.clearTimeout(A);Zf.push.apply(Zf,Ia);var d=((Ck||{}).config||{}).update;d?d(f):f&&T(U,"cu",[]).push(f);if(b){Ik("me0",a,Yd);try{el(b,c,n)}finally{Ik("me1",a,Yd)}}return 1}
a=Ak(a)||[];var e=b.callback,f=b.config,h=b.timeout,k=b.ontimeout,m=b.onerror,n=void 0;"function"==typeof m&&(n=m);var A=null,jb=!1;if(h&&!k||!h&&k)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var m=T(Fk(c),"r",[]).sort(),Zf=T(Fk(c),"L",[]).sort(),Yd=[].concat(m);0<h&&(A=uk.setTimeout(function(){jb=!0;k()},h));
var Ia=al(a,Zf);if(Ia.length){var Ia=al(a,m),qb=T(U,"CP",[]),rb=qb.length;qb[rb]=function(a){function b(){var a=qb[rb+1];a&&a()}
function c(b){qb[rb]=null;d(Ia,a)&&Ek(function(){e&&e();b()})}
if(!a)return 0;Ik("ml1",Ia,Yd);0<rb&&qb[rb-1]?qb[rb]=function(){c(b)}:c(b)};
if(Ia.length){var ah="loaded_"+U.I++;Ck[ah]=function(a){qb[rb](a);Ck[ah]=null};
a=Rk(c,Ia,"gapi."+ah,m);m.push.apply(m,Ia);Ik("ml0",Ia,Yd);b.sync||uk.___gapisync?bl(a):cl(a)}else qb[rb](xk)}else d(Ia)&&e&&e()}
...
function mm(a,b){var c=a.b.length!=b.length;a.b=Ja(a.b,function(a){return!!im(b,a)});
for(var d=0,e=b.length;d<e;d++)c=lm(a,b[d])||c;return c}
function nm(a,b){var c=a.b.length;a.b=Ja(a.b,function(a){return!(a||b?!a!=!b?0:a.id==b.id:1)});
return a.b.length<c}
...
g.Hc=function(){this.f=NaN;this.b=Xd(em(this.A,"/pairing/get_screen"),{method:"POST",O:{pairing_code:this.l},timeout:5E3,R:x(this.He,this),onError:x(this.Ge,this),ka:x(this.Ie,this)})};
...
g.Ie=function(){this.b=null;this.B("pairingFailed",Error("Server not responding"))};function qm(a){this.app=this.name=this.id="";this.type="REMOTE_CONTROL";this.avatar=this.username="";this.capabilities=new Xc;this.experiments=new Xc;this.theme="u";if(a){this.id=a.id||a.name;this.name=a.name;this.app=a.app;this.type=a.type||"REMOTE_CONTROL";this.username=a.user||"";this.avatar=a.userAvatarUri||"";this.theme=a.theme||"u";var b=a.capabilities||"";this.capabilities.clear();Yc(this.capabilities,Ja(b.split(","),ma(ab,cm)));a=a.experiments||"";this.experiments.clear();Yc(this.experiments,
a.split(","))}}
...
g.ea=function(a){return a?this.b:Sa(this.b,Ja(this.i,function(a){return!this.contains(a)},this))};
g.Sc=function(){return Ja(this.ea(!0),function(a){return!!this.f.b[a.id]},this)};
...
g.Ke=function(a,b,c,d){Xd(em(this.l,"/pairing/get_screen"),{method:"POST",O:{pairing_code:a},timeout:5E3,R:x(function(a,d){a=new Wl(d.screen||{});if(!a.name||Vm(this,a.name)){a:{d=a.name;for(var e=2,f=b(d,e);Vm(this,f);){e++;if(20<e)break a;f=b(d,e)}d=f}a.name=d}c(Tm(this,a))},this),
...
Xd(em(a.l,"/pairing/get_lounge_token_batch"),e)}
...
g.Le=function(a){this.D()||a||(Zm(this,"Cast session died."),this.ba())};function cn(a,b){Ym.call(this,a,b,"DialSession");this.i=this.G=null;this.L="";this.j=null;this.A=t;this.l=NaN;this.P=x(this.Oe,this);this.f=t}
...
function Xn(a,b){a.ib=y();Zn(a);a.za=a.wa.clone();Zh(a.za,"t",a.l);a.lb=0;a.S=a.b.Jb(a.b.jb()?b:null);0<a.Qb&&(a.zb=new Jn(x(a.Rc,a,a.S),a.Qb));a.i.ub(a.S,"readystatechange",a.ne);b=a.Fa?ib(a.Fa):{};a.Ja?(a.Fb="POST",b["Content-Type"]="application/x-www-form-urlencoded",a.S.send(a.za,a.Fb,a.Ja,b)):(a.Fb="GET",a.Mc&&!hd&&(b.Connection="close"),a.S.send(a.za,a.Fb,null,b));a.b.ja(1)}
...
g.ja=function(a){this.b.ja(a)};function uo(a){bh.call(this);this.headers=new Oc;this.L=a||null;this.f=!1;this.H=this.b=null;this.$="";this.j=0;this.o="";this.i=this.U=this.l=this.P=!1;this.G=0;this.A=null;this.ra="";this.da=this.oa=!1}
...
;function Eo(a,b,c){this.l=a||null;this.b=1;this.f=[];this.i=[];this.j=new Gn(null,!0);this.A=b||null;this.T=null!=c?c:null}
...
;function bp(a,b){this.H=a;this.o=b;this.g=new G;this.f=new $o(this.Fe,this);this.b=null;this.G=!1;this.j=null;this.T="";this.A=this.i=0;this.l=[]}
...
g.kc=function(a,b){"S"==b[0]?this.T=b[1]:"gracefulReconnect"==b[0]?(ap(this.f),this.f.start(),Ko(this.b)):this.B("handlerMessage",new En(b[0],b[1]))};
...
gp.prototype.clone=function(){return new gp(jp(this))};function Z(a,b,c){V.call(this);this.i=NaN;this.$=!1;this.L=this.H=this.P=this.U=NaN;this.aa=[];this.A=this.G=this.g=this.F=this.b=null;this.Xa=a;this.aa.push(M(window,"beforeunload",x(this.xd,this)));this.f=[];this.F=new gp;this.oa=b.id;this.b=kp(this,c);this.b.subscribe("handlerOpened",this.Ld,this);this.b.subscribe("handlerClosed",this.Id,this);this.b.subscribe("handlerError",this.Jd,this);this.b.subscribe("handlerMessage",this.Kd,this);fp(this.b,b.token);this.subscribe("remoteQueueChange",function(){var a=
...
g.w=function(){op(this);pp(this);qp(this);J(this.H);this.H=NaN;J(this.L);this.L=NaN;this.g=null;Ue(this.aa);this.aa.length=0;this.b.dispose();Z.C.w.call(this);this.A=this.G=this.f=this.F=this.b=null};
...
g.w=function(){qq.C.w.call(this);delete this.b};function tq(a,b,c,d){F.call(this);this.b=b||null;this.A="*";this.i=c||null;this.f=null;this.channel=d||null;this.H=!!a;this.G=x(this.L,this);window.addEventListener("message",this.G)}
...
tq.prototype.l=u;tq.prototype.sendMessage=function(a){if(this.b){this.f&&(a.id=this.f);this.channel&&(a.channel=this.channel);try{var b=L(a);this.b.postMessage(b,this.A)}catch(c){ic(c,"WARNING")}}};
...
(function(){if(tf)return Dq(/Firefox\/([0-9.]+)/);if(K||fd||ed)return od;if(xf)return Dq(/Chrome\/([0-9.]+)/);if(yf&&!(ad()||D("iPad")||D("iPod")))return Dq(/Version\/([0-9.]+)/);if(uf||vf){var a=/Version\/(\S+).*Mobile\/(\S+)/.exec(nb);if(a)return a[1]+"."+a[2]}else if(wf)return(a=Dq(/Android\s+([0-9.]+)/))?a:Dq(/Version\/([0-9.]+)/);return""})();function Eq(){var a=ib(Fq);return new mh(function(b,c){a.R=function(a){Sd(a)?b(a):c(a)};
...
q("yt.logging.errors.log",function(a,b,c,d,e){c={name:c||H("INNERTUBE_CONTEXT_CLIENT_NAME",1),version:d||H("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0)};e=window&&window.yterr||e||!1;if(a&&e&&!(5<=de)){e=a.stacktrace;d=a.columnNumber;var f=r("window.location.href");if(w(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:f,stack:"Not available"};else{var h,k,m=!1;try{h=a.lineNumber||a.ff||"Not available"}catch(jb){h="Not available",m=!0}try{k=a.fileName||a.filename||a.sourceURL||
l.$googDebugFname||f}catch(jb){k="Not available",m=!0}a=!m&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:k,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(d)||(h=h+":"+d);if(!(ce[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){b={Xb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:h,level:b||"ERROR"},O:{url:H("PAGE_NAME",
