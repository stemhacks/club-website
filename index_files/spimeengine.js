...
SpimeEngine.getProductUrl = function(pid){
	//var productUrl = absoluteUrl + "/product/" + relevantItem.attr("id");
	//var pathNameArr = location.pathname.split("/");
	return window.location.protocol + "//" + window.location.host + location.pathname + "/product/" + pid;
};
				...
				if (isRegistrationForm){
					try{
			    		if (typeof IMOS != "undefined"){
			    			...
			    			//TODO: mailing list IMOS.handleNewsLetterIntegration(submitParams);
						}
					}catch(err){
					}
				}
